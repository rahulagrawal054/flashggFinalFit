...
python3 makeDatacard.py \
  ...
  --output Datacard_StatOnly 

#2022preEE=/eos/user/r/rkumarag/OLD_OUTPUT/OutputForFinalFit_WithOutSyst/workspaces/2022preEE/ws_signal,\
#2022postEE=/eos/user/r/rkumarag/OLD_OUTPUT/OutputForFinalFit_WithOutSyst/workspaces/2022postEE/ws_signal,\
#2023preBPix=/eos/user/r/rkumarag/OLD_OUTPUT/OutputForFinalFit_WithOutSyst/workspaces/2023preBPix/ws_signal,\
#2023postBPix=/eos/user/r/rkumarag/OLD_OUTPUT/OutputForFinalFit_WithOutSyst/workspaces/2023postBPix/ws_signal \
