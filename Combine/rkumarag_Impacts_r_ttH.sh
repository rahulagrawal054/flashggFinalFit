#!/bin/bash
# ==========================================================
# Script: run_impacts_r_ttH.sh
# Purpose: Run Combine impact plot workflow for r_ttH analysis locally
...
mkdir -p Impacts_r_ttH
cd Impacts_r_ttH

# ----------------------------------------------------------
# 2. Copy your datacard (adjust path if needed)
# ----------------------------------------------------------
cp ../Datacard_r_ttH_1D.root .
...
# ----------------------------------------------------------
# 4. Run the initial fit to find the best-fit POI (r_ttH)
# ----------------------------------------------------------
combineTool.py -M Impacts \
-d Datacard_r_ttH_1D.root \
-m 125.38 \
--doInitialFit \
--robustFit 1 \
-t -1 \
--setParameters r_ttH=1 \
--setParameterRanges r_ttH=-0.5,3 \
$COMMON_OPTS \
--freezeParameters MH
...
# ----------------------------------------------------------
plotImpacts.py \
-i impacts_r_ttH_corrected_dropBkgModelParams.json \
-o impacts_r_ttH_corrected_dropBkgModelParams

# ----------------------------------------------------------
# 10. Done
# ----------------------------------------------------------
echo "Impact plots successfully created:"
echo "  - impacts_r_ttH_allParams.pdf / .png"
echo "  - impacts_r_ttH_corrected_dropBkgModelParams.pdf / .png"
