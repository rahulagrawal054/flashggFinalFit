...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/user/r/rkumarag/hgg_tth_th_cp_analysis/finalFitPreparation/outputForFinalFits_03Nov2025_Nominal/workspaces/2023postBPix/ws_signal/', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_2023postBPix_StatOnly', # output directory extension
