...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/user/r/rkumarag/hgg_tth_th_cp_analysis/finalFitPreparation/outputForFinalFits_03Nov2025/workspaces/2022preEE/ws_signal/', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_2022preEE_WithSyst', # output directory extension
