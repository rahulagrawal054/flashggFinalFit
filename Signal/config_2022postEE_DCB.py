...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/eos/user/r/rkumarag/hgg_tth_th_cp_analysis_Bf19Dec/finalFitPreparation/workspaces_03Nov/2022postEE/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_2022postEE_DCB', # output directory extension
